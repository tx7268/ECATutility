...
public:
    ...
    void appendSample(qint32 actualPosition, qint32 targetPosition, qint32 realVelocity, quint32 feedbackFreq);
...
private:
    ...
    QLineSeries* m_realVelocitySeries = nullptr; // 驱动器传回的速度
